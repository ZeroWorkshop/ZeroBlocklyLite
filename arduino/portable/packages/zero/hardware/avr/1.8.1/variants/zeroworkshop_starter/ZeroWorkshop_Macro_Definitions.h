...
//#define SERVO_ZW1100   //Since Servo ZW1100 and ZW780 has opposite turning direction(from 0 to 180), define this macro to make sure the servo runs in the right direction


#define POSITIVE 1   //For 780 servo, the direction is opposite to others. So for 780, define POSITIVE as 1 as NEGATIVE as -1
#define NEGATIVE -1
...
#define handlebar_B2_SERVO     ZW_B2
...
#define Left_initPos  90
#define Right_initPos  90
...
#define OpenCloseinitPos  180
#define UpDowninitPos 0


#define barinitPos 55
