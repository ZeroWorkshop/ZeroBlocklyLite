...
#ifndef __NEXTION_SIMPLE_H__
#define __NEXTION_SIMPLE_H__
...
#endif
 public:
    NextionSimple(){};//Empty contructor
#if defined(USE_SOFTWARE_SERIAL)
  NextionSimple(SoftwareSerial &next, uint32_t baud);//Constructor
#else
  NextionSimple(HardwareSerial &next, uint32_t baud);//Constructor
#endif
