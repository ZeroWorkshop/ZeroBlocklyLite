...
//Below comments are added by Qixin for understanding the protocol
/*
The data structure for the template above is as below:
_____            __________________      ______________      ______________      ____________________      ______________
    |____________|                |______|            |______|            |______|                  |______|            |______|....
        HDR_MARK       HDR_SPACE  BIT_MARK ZERO_SPACE BIT_MARK ZERO_SPACE BIT_MARK   ONE_SPACE      BIT_MARK ZERO_SPACE  BIT_MARK

The data above should be translated to 0 0 1 0...
