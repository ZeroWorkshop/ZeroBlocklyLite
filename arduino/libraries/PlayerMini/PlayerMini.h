...
#ifndef PlayerMini_cpp
    #define PlayerMini_cpp
...
#define TimeOut 0
#define WrongStack 1
#define PlayerCardInserted 2
#define PlayerCardRemoved 3
#define PlayerCardOnline 4
#define PlayerPlayFinished 5
#define PlayerError 6
#define PlayerUSBInserted 7
#define PlayerUSBRemoved 8
#define PlayerUSBOnline 9
#define PlayerCardUSBOnline 10
#define PlayerFeedBack 11
...
class PlayerMini {
  ...
  uint8_t _received[PLAYER_RECEIVED_LENGTH];
  uint8_t _sending[PLAYER_SEND_LENGTH] = {0x7E, 0xFF, 06, 00, 01, 00, 00, 00, 00, 0xEF};
  ...
  uint8_t device = PLAYER_DEVICE_SD;
  ...
  void VoiceWord(int num);
  
  void VoiceWeight(int value);
