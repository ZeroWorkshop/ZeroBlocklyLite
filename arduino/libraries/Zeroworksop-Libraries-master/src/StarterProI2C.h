 ...
 *
*/
#ifndef _STARTERPROI2C_H_
#define _STARTERPROI2C_H_
 ...
 */
  ...
  void getStepperCount(uint8_t slot,long * count);
  void stepperControlsync(uint8_t slot,long speed, long step1,long step2);
  void servoWrite(uint8_t pin, uint8_t dValue);
  
  
  void getPower(long * val);
  double getPower();
