...
document.write('<script src="../../blockly_common/msg/js/' + Code.LANG + '.js"></script>\n');
document.write('<script src="../../blockly_common/msg/js/company/' + Code.LANG + '.js"></script>\n');
document.write('<script src="../../blockly_common/apps/mixly/js/conf/theme.js?t=' + new Date().getTime() + '"></script>\n');
