...
Blockly.Blocks.controls_whileUntil.OPERATORS =//perators
...
//	    var options = [
//    ['left', '../../media/ZeroWorkshop/ZW_leftturn.jpg'],
//    ['right', '../../media/ZeroWorkshop/ZW_rightturn.jpg'],
//    ['forward', '../../media/ZeroWorkshop/ZW_forward.jpg'],
//    ['reverse', '../../media/ZeroWorkshop/ZW_reverse.jpg'],
//    ['brake', '../../media/ZeroWorkshop/ZW_brake.jpg']
//  ];
...
//         .appendField(dropdown, 'Movement'+i)
...
//}
		...
		init:function (){
			this.setColour(Blockly.Blocks.loops.HUE);
			this.appendDummyInput().appendField('MsTimer2').appendField(Blockly.MIXLY_MSTIMER2_EVERY);
			this.appendValueInput('TIME').setCheck(Number);
			this.appendDummyInput().appendField('ms');
			this.appendStatementInput('DO').appendField(Blockly.MIXLY_MSTIMER2_DO);
			this.setPreviousStatement(true);
			this.setNextStatement(true);
//			this.setInputsInline(true);
		}
