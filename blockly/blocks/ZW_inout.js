...
Blockly.Blocks['ZWinout_highlow'] = {
   init: function() {
    this.setColour(20);
...
Blockly.Blocks['ZWinout_pinMode'] = {
    init: function() {
        this.setColour(20);
...
Blockly.Blocks.ZWinout_digital_write = {
  init: function() {
    this.setColour(20);
    this.appendDummyInput("")
...
Blockly.Blocks.ZWinout_digital_write2 = {
  init: function() {
    this.setColour(20);
    this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_DIGITALWRITE_PIN)
...
Blockly.Blocks.ZWinout_digital_read = {
  init: function() {
    this.setColour(20);
    this.appendDummyInput("")
...
Blockly.Blocks.ZWinout_digital_read2 = {
  init: function() {
    this.setColour(20);
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_DIGITALREAD_PIN)
...
Blockly.Blocks.ZWinout_analog_read = {
  init: function() {
    this.setColour(20);
	this.appendValueInput("PIN", Number)
...
Blockly.Blocks.ZWinout_buildin_led = {
   init: function() {
     this.setColour(20);
     this.appendDummyInput("")
...
Blockly.Blocks.ZWcontrols_attachInterrupt = {
  init: function() {
    this.setColour(20);
	this.appendValueInput("PIN", Number)
...
Blockly.Blocks.ZWcontrols_detachInterrupt = {
  init: function() {
    this.setColour(20);
	this.appendValueInput("PIN", Number)
...
Blockly.Blocks.ZWcontrols_attachPinInterrupt = {
    init: function () {
        this.setColour(20);
        this.appendValueInput("PIN", Number)
...
Blockly.Blocks.ZWcontrols_detachPinInterrupt = {
    init: function () {
        this.setColour(20);
        this.appendValueInput("PIN", Number)
...
Blockly.Blocks.ZWinout_pulseIn = {
  init: function() {
    this.setColour(20);
	this.appendValueInput("PIN", Number)
...
Blockly.Blocks.ZWinout_pulseIn2 = {
  init: function() {
    this.setColour(20);
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PULSEIN)
...
Blockly.Blocks.ZWinout_shiftout = {
  init: function() {
    this.setColour(20);
    this.appendDummyInput("")
