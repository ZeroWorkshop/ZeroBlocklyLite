...
Blockly.Arduino.beatleAIRequest = function () {
	...
	var code;
  Blockly.Arduino.definitions_['include_beatleAICam'] = '#include "HUSKYLENS.h"\n';
  
  
	Blockly.Arduino.definitions_['declare_beatleAICam'] = 'HUSKYLENS huskylens;' + '\n';



	

	Blockly.Arduino.setups_['setup_beatleAICam'] = 'Wire.begin();' + '\n' +
...
Blockly.Arduino.beatleAIisLearnedAny = function () {
	var requestID = this.getFieldValue('ID');
...
Blockly.Arduino.beatleAIisAvailable = function () {
	var requestID = this.getFieldValue('ID');
...
Blockly.Arduino.beatleAIRead = function () {
	var requestID = this.getFieldValue('ID');
  ...
  Blockly.Arduino.definitions_['include_beatleAICam'] = '#include "HUSKYLENS.h"\n';
	...
	code = 'HUSKYLENSResult result = huskylens.read();\n';
...
Blockly.Arduino.beatleAItrackTarget = function () {
	var requestID = this.getFieldValue('ID');
...
Blockly.Arduino.beatleAIisInCam = function () {
  ...
  if (requestType == "requestBlocks")
	    ...
	    code = 'huskylens.countBlocks(' + requestID + ')';
	else if (requestType == "requestArrows")
	    //code = 'huskylens.isAppear(' + requestID + ',HUSKYLENSResultArrow)';
	    code = 'huskylens.countArrows(' + requestID + ')';
...
Blockly.Arduino.beatleESP32Servo = function() {
  ...
  Blockly.Arduino.definitions_['include_beatleESP32Servo'] = '#include "io_expander.h"\n';
	Blockly.Arduino.definitions_['declare_beatleESP32Servo'] = 'IOExpander  ioexpander(0x18);\n' +
	                                                           'int pos = 90;\n';

	Blockly.Arduino.setups_['beatle_serial'] = 'Serial.begin(115200);\n';

	Blockly.Arduino.setups_['beatle_beatleESP32Servo'] = 'ioexpander.begin();\n' + '  ioexpander.servoWrite(pos);\n';
...
//////////////////////////////////////////////////////////////////////////
Blockly.Arduino.beatleESP32WebRadioList = function() {
  var station = this.getFieldValue('radiostation');

	Blockly.Arduino.definitions_['include_beatleESP32WebRadio'] = '#include "beatleESP32_webRadio.h"';
	Blockly.Arduino.definitions_['declare_beatleESP32WebRadio'] = '';

	

	Blockly.Arduino.setups_['beatle_beatleESP32WebRadioList'] = '';
  
  var code;
  if (station == "station1")
      code = 'http://lhttp.qingting.fm/live/1206/64k.mp3';
  else if (station == "station2")
      code = 'http://lhttp.qingting.fm/live/5021641/64k.mp3';
  else if (station == "station3")
      code = 'http://lhttp.qingting.fm/live/1209/64k.mp3';
  else if (station == "station4")
      code = 'http://lhttp.qingting.fm/live/1208/64k.mp3';        
  

	return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.beatleESP32WebRadio = function() {
  var SSID = Blockly.Arduino.valueToCode(this, 'SSID', Blockly.Arduino.ORDER_ATOMIC);
  var PWD = Blockly.Arduino.valueToCode(this, 'PWD', Blockly.Arduino.ORDER_ATOMIC);
  ...
  Blockly.Arduino.setups_['setup_beatleESP32WebRadio'] = 'webradiosetup(ssid, password,host);\n'
  
  var code = 'webradioloop();\n';    
...
Blockly.Arduino.beatleESP32speechSynthesis = function() {
  var SSID = Blockly.Arduino.valueToCode(this, 'SSID', Blockly.Arduino.ORDER_ATOMIC);
  var PWD = Blockly.Arduino.valueToCode(this, 'PWD', Blockly.Arduino.ORDER_ATOMIC);
  var token = Blockly.Arduino.valueToCode(this, 'token', Blockly.Arduino.ORDER_ATOMIC);
  var speechtext = this.getFieldValue('speechTXT');
  var vol = Blockly.Arduino.valueToCode(this, 'speechVol', Blockly.Arduino.ORDER_ATOMIC);
  var spd = Blockly.Arduino.valueToCode(this, 'speechSpd', Blockly.Arduino.ORDER_ATOMIC);
  var pit = Blockly.Arduino.valueToCode(this, 'speechPit', Blockly.Arduino.ORDER_ATOMIC);
  
  var person = this.getFieldValue('person');
  var perID;
  if (person == "person1")
      perID = 1;
  ...
  Blockly.Arduino.definitions_['include_beatleESP32speechSynthesis'] = '#include "beatleESP32_speechSynthesis.h"';
  
	Blockly.Arduino.definitions_['declare_beatleESP32speechSynthesis'] = 'const char* ssid = ' + SSID + ';\n' +
                                                                       'const char* password = ' + PWD + ';\n' +
                                                                       'const char* token = ' + token + ';\n' +
                                                                       'const char* speechtext = "' + speechtext + '";\n' +
                                                                       'int volID = ' + vol + ';\n' +
                                                                       'int spdID = ' + spd + ';\n' +
                                                                       'int pitID = ' + pit + ';\n' +
                                                                       'int perID = ' + perID + ';\n';
                                                                
  Blockly.Arduino.setups_['setup_beatleESP32speechSynthesis'] = 'speechSynsetup(ssid, password, token, speechtext, volID, perID, spdID, pitID);\n'
  
  
  var code = 'speechSynloop();\n';    
...
Blockly.Arduino.beatleESP32StopFollowline = function() {
  var command = Blockly.Arduino.valueToCode(this, 'CMD', Blockly.Arduino.ORDER_ATOMIC);
  ...
  var code='bSerial.stopFollowLine();\n';
