...
var MSG = {
	...
	catBeatleAICam:"BeatleESP32AI摄像头",
	catBeatleESP32Sensor: "BeatleESP32传感器",
	catBeatleESP32Actuator: "BeatleESP32执行器",
	catBeatleESP32LCD: "BeatleESP32液晶屏",
...
Blockly.beatleESP32ReadTempvalue="返回BealteESP32板上温度";
Blockly.beatleESP32ReadHumvalue="返回BealteESP32板上湿度";
Blockly.beatleESP32ReadPressurevalue="返回BealteESP32板上气压值";
Blockly.beatleESP32ReadGesturevalue="获取BealteESP32手势传感器读值";
Blockly.beatleESP32GestureSensored="返回手势为";
Blockly.beatleESP32GestureUP="上";
Blockly.beatleESP32GestureDOWN="下";
Blockly.beatleESP32GestureLEFT="左";
Blockly.beatleESP32GestureRIGHT="右";
Blockly.beatleESP32ReadIRRecordervalue="学习并记录红外线遥控器按键值";
Blockly.beatleESP32SendIRvalue="发送红外线数据";
Blockly.beatleESP32IRencoding="红外线编码格式";
...
Blockly.beatleESP32IRkeyValue="按键值";
Blockly.beatleESP32getIRbuttonKey="获取红外按键值";
Blockly.beatleESP32compareIRbuttonKey="按键值等于";
Blockly.beatleESP32ReadGyroAllValue="返回陀螺仪传感器值";
Blockly.beatleESP32ReadSoundDBValue="返回麦克风探测到的分贝值";
Blockly.beatleESP32KeepDirection="运动方向保持（陀螺仪）";
Blockly.beatlePitch="俯仰角pitch";
Blockly.beatleRoll="翻滚角roll";
Blockly.beatleYaw="偏航角yaw";
Blockly.beatleESP32ReadAccValue="返回陀螺仪";
Blockly.beatleIMUX="X";
Blockly.beatleIMUY="Y";
Blockly.beatleIMUZ="Z";
Blockly.beatleESP32IMUAxis="轴";
Blockly.beatleESP32IMUAccValue="加速度值";
Blockly.beatleESP32ReadGyroValue="返回陀螺仪";
Blockly.beatleESP32IMUGyroValue="陀螺仪值";
Blockly.beatleWheelLeft="左";
Blockly.beatleWheelRight="右";
Blockly.beatleWheelForward="前进";
Blockly.beatleWheelBackward="后退";
Blockly.beatleWheelStop="停止";
Blockly.beatleWheelSpeed="速度(0~255之间):";
Blockly.beatleWheelRuntime="持续:";
Blockly.beatleWheel="轮";
Blockly.beatleLWheel="左轮";
Blockly.beatleRWheel="右轮";
Blockly.BeatleESP32PlayMP3="播放SD卡中的MP3文件:";
Blockly.BeatleESP32PlayMP3fromSD="在屏幕上选择播放SD卡中的MP3文件";
Blockly.beatleESP32Servo="设置舵机角度为";
Blockly.beatleESP32ServoAngle="角度(0~180之间):";
Blockly.beatleESP32Cls="清除屏幕并设置颜色为:";
Blockly.beatleESP32Pic="显示图片";
Blockly.beatleESP32PicXY="起始坐标";
Blockly.beatleESP32PicX="X=";
Blockly.beatleESP32PicY="Y=";
Blockly.beatleESP32PicID="图片ID=";
Blockly.beatleESP32String="书写字符";
Blockly.beatleESP32PicW="区域宽度=";
Blockly.beatleESP32PicH="区域高度=";
Blockly.beatleESP32FontID="字库ID=";
Blockly.beatleESP32backcolor="背景色";
Blockly.beatleESP32XAlign="水平对齐方式";
Blockly.beatleESP32YAlign="垂直对齐方式";
Blockly.beatleESP32LeftAlign="左对齐";
Blockly.beatleESP32RightAlign="右对齐";
Blockly.beatleESP32MiddleAlign="居中";
Blockly.beatleESP32BackgroundStatus="背景填充方式";
Blockly.beatleESP32backstatus0="切图";
Blockly.beatleESP32backstatus1="单色";
Blockly.beatleESP32backstatus2="图片";
Blockly.beatleESP32backstatus3="无背景";
Blockly.beatleESP32Fill="区域填充";
Blockly.beatleESP32FillColor="填充颜色";
Blockly.beatleESP32Line="画直线";
Blockly.beatleESP32PicX2Y2="终点坐标";
Blockly.beatleESP32PicX2="X2=";
Blockly.beatleESP32PicY2="Y2=";
Blockly.beatleESP32Rectangle="画矩形";
Blockly.beatleESP32Circle="画空心圆";
Blockly.beatleESP32CircleXY="圆心坐标";
Blockly.beatleESP32PicRadius="半径";
Blockly.beatleESP32PicR="r=";
Blockly.beatleESP32Circle2="画实心圆";
Blockly.beatleESP32LineColor="画线颜色";
Blockly.HMIColor="HMI屏幕颜色";
Blockly.beatleESP32fontcolor="字体颜色";
Blockly.beatleESP32PS4padPressed="按下蓝牙遥控器按键";
Blockly.beatleESP32PS4padButton="按键";
Blockly.beatleESP32PS4buttonUP="上";
Blockly.beatleESP32PS4buttonDOWN="下";
Blockly.beatleESP32PS4buttonLEFT="左";
Blockly.beatleESP32PS4buttonRIGHT="右";
Blockly.beatleESP32PS4buttonTRIANGLE="三角";
Blockly.beatleESP32PS4buttonCROSS="大叉";
Blockly.beatleESP32PS4buttonSQUARE="方块";
Blockly.beatleESP32PS4buttonCIRCLE="圆圈";
...
Blockly.beatlePS4padMAC="蓝牙遥控器MAC地址";
Blockly.beatleLEDnumber="LED灯数";
Blockly.beatleMS="毫秒";
Blockly.beatleRainbow="彩虹渐变";
Blockly.beatleTheaterRainbow="剧院彩虹";
Blockly.beatleLEDfunc="LED效果";
Blockly.beatleInterval="间隔";
Blockly.beatleSetRGB="设置RGB";
Blockly.beatleESP32Policelight="RGB彩灯警灯效果";
Blockly.beatleESP32Weatherstation="Wifi气象站";
Blockly.beatleESP32WebRadio="网络收音机";
Blockly.beatleESP32WebRadioList="网络收音机电台列表";
Blockly.beatleESP32Radio4="河南音乐广播";
Blockly.beatleESP32Radio3="河南交通广播";
Blockly.beatleESP32Radio2="汽车音乐广播";
Blockly.beatleESP32Radio1="流行音乐先锋";
Blockly.beatleESP32Radiostation="播放电台";
Blockly.WifiSSID="WIFI 网络";
Blockly.WifiPASSWORD="WIFI 密码";
Blockly.beatleESP32speechSynthesis="语音合成";
Blockly.beatleESP32speechVol="语音音量(0~15)";
Blockly.beatleESP32speechSpd="语音语速(0~15)";
Blockly.beatleESP32speechPit="语音音调(0~15)";
Blockly.beatleESP32BaiduToken="百度AI token";
Blockly.beatleESP32speechPer="语音人物";
Blockly.beatleESP32person1="度小宇";
Blockly.beatleESP32person2="度小美";
Blockly.beatleESP32person3="度逍遥";
Blockly.beatleESP32person4="度丫丫";
Blockly.beatleESP32MazeSolvergotoFinish="巡线";
Blockly.beatleESP32MazeSolvergotoTarget="执行路口指令至指定路口";
Blockly.beatleESP32MazeSolverTargetReached="内到达指定路口";
Blockly.beatleESP32MazeSolverWaitUntillTargetReached="等待到达指定路口";
Blockly.beatleESP32MazeSolveTimeout="超时设定";
Blockly.beatleESP32reachTargetIn="在";
Blockly.beatleAICamera="AI摄像头";
Blockly.beatleAIisAvailable="返回可读取的块数和箭头数";
Blockly.beatleAIRead="从摄像头中读取方块和箭头数据";
Blockly.beatleESP32ServoScan="舵机180度扫描";
Blockly.beatleESP32ServoScanStopAngle="停止舵机扫描在";
Blockly.beatleAItrackTarget="摄像头跟随目标(配合云台舵机)";
Blockly.beatleESP32MazeSolvergotoTargetCmd="指令";
Blockly.beatleESP32WaitforStart="等待按下屏幕上START按键";
Blockly.beatleESP32StopFollowline="停止巡线";