...
var MSG = {
	...
	catBeatleAICam: "BeatleESP32 AI Camera",
	catBeatleESP32Sensor: "BeatleESP32 Sensors",
	catBeatleESP32Actuator: "BeatleESP32 Actuators",
	catBeatleESP32LCD: "BeatleESP32 LCD Screen",
...
Blockly.beatleESP32ReadTempvalue="Return temprature of BealteESP32";
Blockly.beatleESP32ReadHumvalue="Return humidity of BealteESP32";
Blockly.beatleESP32ReadPressurevalue="Return air pressure of BealteESP32";
Blockly.beatleESP32ReadGesturevalue="Get gesture value of BeatleESP32 gesture sensor";
Blockly.beatleESP32GestureSensored="gesture sensored is";
...
Blockly.beatleESP32ReadIRRecordervalue="Learn and record the button value of IR controller";
Blockly.beatleESP32SendIRvalue="Send IR data";
Blockly.beatleESP32IRencoding="IR encoding type";
Blockly.beatleESP32IRsendUNKNOWN="UNKNOWN";
...
Blockly.beatleESP32IRkeyValue="Key value";
Blockly.beatleESP32getIRbuttonKey="Get IR button key value";
Blockly.beatleESP32compareIRbuttonKey="IR button key value is";
Blockly.beatleESP32ReadGyroAllValue="Return all values of Gyro sensor";
Blockly.beatleESP32ReadSoundDBValue="Return the DB value of the Mic";
Blockly.beatleESP32KeepDirection="Keep moving direction(Gyroscope)";
Blockly.beatleESP32ReadAccValue="Return Accelerator value of";
Blockly.beatlePitch="Pitch";
Blockly.beatleRoll="Roll";
Blockly.beatleYaw="Yaw"
Blockly.beatleIMUX="X";
Blockly.beatleIMUY="Y";
Blockly.beatleIMUZ="Z";
Blockly.beatleESP32IMUAxis="Axis";
Blockly.beatleESP32IMUAccValue="";
Blockly.beatleESP32ReadGyroValue="Return Gyroscope value of";
Blockly.beatleESP32IMUGyroValue="";
Blockly.beatleWheelLeft="LEFT";
Blockly.beatleWheelRight="RIGHT";
Blockly.beatleWheelForward="Forward";
Blockly.beatleWheelBackward="Backward";
Blockly.beatleWheelStop="Stop";
Blockly.beatleWheelSpeed="Speed(0~255):";
Blockly.beatleWheel="Wheel";
Blockly.beatleLWheel="Left Wheel";
Blockly.beatleRWheel="Right Wheel";
Blockly.BeatleESP32PlayMP3="Play the MP3 file in the SD card:";
Blockly.BeatleESP32PlayMP3fromSD="Select a mp3 to play from SD card on the screen";
Blockly.beatleESP32Servo="Set Servo angle to ";
Blockly.beatleESP32ServoAngle="Angle(0~180):";
Blockly.beatleESP32Cls="Clear screen and set the background color:";
Blockly.beatleESP32Pic="Show picture";
Blockly.beatleESP32PicXY="Starting coordination";
Blockly.beatleESP32PicX="X=";
Blockly.beatleESP32PicY="Y=";
Blockly.beatleESP32PicID="Pic ID=";
Blockly.beatleESP32String="Write string";
Blockly.beatleESP32PicW="Width=";
Blockly.beatleESP32PicH="Height=";
Blockly.beatleESP32FontID="Font ID=";
Blockly.beatleESP32backcolor="Background color";
Blockly.beatleESP32XAlign="Horizontal alignment";
Blockly.beatleESP32YAlign="Vertical alignment";
Blockly.beatleESP32LeftAlign="Align left";
Blockly.beatleESP32RightAlign="Align right";
Blockly.beatleESP32MiddleAlign="Align center";
Blockly.beatleESP32BackgroundStatus="Background filling";
Blockly.beatleESP32backstatus0="cut pic";
Blockly.beatleESP32backstatus1="single color";
Blockly.beatleESP32backstatus2="pic";
Blockly.beatleESP32backstatus3="no background";
Blockly.beatleESP32Fill="Fill area";
Blockly.beatleESP32FillColor="fill color";
Blockly.beatleESP32Fill="Draw line";
Blockly.beatleESP32PicX2Y2="End coordination";
Blockly.beatleESP32PicX="X2=";
Blockly.beatleESP32PicY="Y2=";
Blockly.beatleESP32Rectangle="Draw rectangle";
Blockly.beatleESP32Circle="Draw circle";
Blockly.beatleESP32CircleXY="Center coordination";
Blockly.beatleESP32PicRadius="radius";
Blockly.beatleESP32PicR="r=";
Blockly.beatleESP32Circle2="Draw filled circle";
Blockly.beatleESP32LineColor="line color";
Blockly.HMIColor="HMI Color";
Blockly.beatleESP32fontcolor="Font Color";
Blockly.beatleESP32PS4padPressed="Button";
Blockly.beatleESP32PS4padButton="is pressed";
...
Blockly.beatlePS4padMAC="PS4 gamepad MAC address";
Blockly.beatleLEDnumber="LED count";
Blockly.beatleMS="ms";
Blockly.beatleRainbow="Rainbow effect";
Blockly.beatleTheaterRainbow="Theatre rainbow effect";
Blockly.beatleLEDfunc="LED effect";
Blockly.beatleInterval="interval";
Blockly.beatleSetRGB="Set RGB";
Blockly.beatleESP32Policelight="Police Light effect";
Blockly.beatleESP32Weatherstation="Wifi Weather Station";
Blockly.beatleESP32WebRadio="Internet radio";
Blockly.beatleESP32WebRadioList="Internet radio station list";
Blockly.beatleESP32Radiostation="Radio station to be played";
Blockly.WifiSSID="WIFI SSID";
Blockly.WifiPASSWORD="WIFI Password";
Blockly.beatleESP32speechSynthesis="Speech synthesis";
Blockly.beatleESP32speechVol="Speech volume(0~15)";
Blockly.beatleESP32speechSpd="Speech speed(0~15)";
Blockly.beatleESP32speechPit="Speech pit(0~15)";
Blockly.beatleESP32BaiduToken="BaiDu AI token";
Blockly.beatleESP32speechPer="Person speaking";
Blockly.beatleESP32person1="度小宇";
Blockly.beatleESP32person2="度小美";
Blockly.beatleESP32person3="度逍遥";
Blockly.beatleESP32person4="度丫丫";
Blockly.beatleESP32MazeSolvergotoFinish="Go to finish line";
Blockly.beatleESP32MazeSolvergotoTarget="Go to the target";
Blockly.beatleESP32MazeSolverTargetReached="reach the target intersection";
Blockly.beatleESP32MazeSolverWaitUntillTargetReached="Wait untill the target is reached";
Blockly.beatleESP32MazeSolveTimeout="Timeout";
Blockly.beatleESP32reachTargetIn="Within";
Blockly.beatleAICamera="AI Camera";
Blockly.beatleAIisAvailable="Return the count of blocks and arrows";
Blockly.beatleAIRead="Read block and arrows data from camera";
Blockly.beatleESP32ServoScan="Servo scan 180 degree";
Blockly.beatleESP32ServoScanStopAngle="Stop servo scan at ";
Blockly.beatleAItrackTarget="Tracking the target(should work with servo)";
Blockly.beatleESP32MazeSolvergotoTargetCmd="Command";
Blockly.beatleESP32WaitforStart="Wait for START button on LCD";
Blockly.beatleESP32StopFollowline="Stop line following";