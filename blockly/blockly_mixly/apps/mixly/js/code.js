...
document.write('<script src="../../blockly_mixly/msg/js/' + Code.LANG + '.js"></script>\n');
document.write('<script src="../../blockly_mixly/msg/js/company/' + Code.LANG + '.js"></script>\n');
document.write('<script src="../../blockly_mixly/apps/mixly/js/conf/theme.js?t=' + new Date().getTime() + '"></script>\n');
