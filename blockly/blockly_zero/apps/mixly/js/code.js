...
document.write('<script src="../../blockly_zero/msg/js/' + Code.LANG + '.js"></script>\n');
document.write('<script src="../../blockly_zero/msg/js/company/' + Code.LANG + '.js"></script>\n');
document.write('<script src="../../blockly_zero/apps/mixly/js/conf/theme.js?t=' + new Date().getTime() + '"></script>\n');
