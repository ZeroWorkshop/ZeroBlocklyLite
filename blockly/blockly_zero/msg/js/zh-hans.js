...
var MSG = {
	...
	catWIFI:'Wi-Fi',
	catMQTT:'MQTT',
	catAllinOne:'Beatle全功能',
	catBeatleBasicFunc:'Beatle可执行',
	catBeatleLogic:'Beatle基础模块',
	catBeatleActuator:'Beatle执行器',
	catBeatleControl:'Beatle控制',
	catBeatleLogic1:'Beatle逻辑',
	catBeatleSensor:'Beatle传感器',
	catArduinoBasic:'Arduino通用模块'
};
...
Blockly.beatleEdgedetect="边沿探测";
Blockly.beatleDance="华丽舞步";
Blockly.beatleAvoid="探测避障";
Blockly.beatleSumo='相扑互博';
Blockly.beatleControl='遥控操作';
Blockly.beatleWheel="轮";
Blockly.beatleLWheel="左轮";
Blockly.beatleRWheel="右轮";
Blockly.beatleBuzzer="蜂鸣器";
Blockly.beatleLED="RGB彩灯";
Blockly.beatleIRSensor="红外线传感器";
Blockly.beatleLineIRSensor="读取红外巡线传感器阵列的值";
...
Blockly.beatlePlaysong='播放旋律:';
Blockly.beatlePlaynote='播放音符';
Blockly.beatleMyMelodylist='我的旋律列表: ';
Blockly.beatleMyMelodylist_TOOLTIP = "建立一个具有任意旋律的列表";
Blockly.beatleIR="侧红外线";
Blockly.beatleIRsensored="探测到障碍物";
Blockly.beatleIRunsensored="没有探测到障碍物";   
...
Blockly.beatleNoteduration="时长";
Blockly.beatleNotevolume="音量";
Blockly.beatleVolumerange="(音量范围0~15)";
Blockly.beatleLEDpin="管脚";
Blockly.beatleLEDnumber="LED灯数";
Blockly.pressPS2button="按下遥控器按键";
Blockly.BPS2_UP="上";
Blockly.BPS2_LEFT="左";
Blockly.BPS2_RIGHT="右";
Blockly.BPS2_DOWN="下";
Blockly.BPS2_TRIANGLE="三角";
Blockly.BPS2_SQUARE="方块";
Blockly.BPS2_CROSS="大叉";
Blockly.BPS2_CIRCLE="圆圈";
Blockly.BPS2_L1="L1";
Blockly.BPS2_L2="L2";
Blockly.BPS2_R1="R1";
Blockly.BPS2_R2="R2";
...
Blockly.BPS2_PS="PS";
Blockly.BPS2_pressLogicalAnd="同时按下所选按键";
Blockly.BPS2_pressLogicalOr= "按下任意所选按键";
Blockly.beatleLineSensorValues="巡线传感器";
Blockly.beatleValueread="的读值";
Blockly.linesensors="巡线传感器:";
Blockly.MaxValue="最大值";
Blockly.MinValue="最小值";
Blockly.linesensorCalibration="设置巡线传感器校准最大最小值";
Blockly.beatleLinePostion="获取线的位置";
Blockly.LineSensorCalibration="启动巡线传感器校准";
Blockly.Yes="是";
Blockly.No="否";
