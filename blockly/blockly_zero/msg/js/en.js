...
var MSG = {
	...
	catWIFI:'Wi-Fi',
	catMQTT:'MQTT',
	catAllinOne:'Beatle All-in-One',
	catBeatleBasicFunc:'Beatle Executable',
	catBeatleLogic:'Beatle Basic Blocks',
	catBeatleActuator:'Beatle Actuators',
	catBeatleControl:'Beatle Controls',
	catBeatleLogic1:'Beatle Logic',
	catBeatleSensor:'Beatle Sensors',
	catArduinoBasic:'Arduino Universal Blocks'
};
...
Blockly.beatleEdgedetect="BorderDetect";
Blockly.beatleDance="Dance";
Blockly.beatleAvoid="ObstacleAvoid";
Blockly.beatleSumo='SumoFight';
Blockly.beatleControl='RemoteControl';
Blockly.beatleWheel="Wheel";
Blockly.beatleLWheel="Left Wheel";
Blockly.beatleRWheel="Right Wheel";
Blockly.beatleBuzzer="Buzzer";
Blockly.beatleLED="RGB LED";
Blockly.beatleIRSensor="IR Sensor";
Blockly.beatleLineIRSensor="Read values of IR Line Sensors";
...
Blockly.beatleWheelRuntime="Duration:";
Blockly.beatleMS="ms";
Blockly.beatleRainbow="Rainblow effect";
Blockly.beatleTheaterRainbow="Theater rainbow effect";
Blockly.beatleLEDfunc="LED Display";
Blockly.beatleInterval="Interval time";
Blockly.beatleSetRGB="Set RGB";
Blockly.beatlePlaysong="Play melody:";
Blockly.beatlePlaynote='Play note';
Blockly.beatleMyMelodylist='My melody list: ';
Blockly.beatleMyMelodylist_TOOLTIP= "Create a melody list with any number of melodies.";
Blockly.beatleIR="IR sensor";
Blockly.beatleIRsensored="detects obstacle";
Blockly.beatleIRunsensored="detects NO obstacle";
...
Blockly.beatleNoteduration="Duration";
Blockly.beatleNotevolume="Volume";
Blockly.beatleVolumerange="(Volume range 0~15)";
Blockly.beatleLEDpin="Pin";
Blockly.beatleLEDnumber="LED counts";
Blockly.pressPS2button="Press PS2 button";
Blockly.BPS2_UP="UP";
Blockly.BPS2_LEFT="LEFT";
Blockly.BPS2_RIGHT="RIGHT";
Blockly.BPS2_DOWN="DOWN";
Blockly.BPS2_TRIANGLE="TRIANGLE";
Blockly.BPS2_SQUARE="SQUARE";
Blockly.BPS2_CROSS="CROSS";
Blockly.BPS2_CIRCLE="CIRCLE";
Blockly.BPS2_L1="L1";
Blockly.BPS2_L2="L2";
Blockly.BPS2_R1="R1";
Blockly.BPS2_R2="R2";
Blockly.BPS2_START="START";
Blockly.BPS2_SELECT="SELECT";
Blockly.BPS2_PS="PS2";
Blockly.BPS2_pressLogicalAnd="All selected buttons";
Blockly.BPS2_pressLogicalOr="Any selected button";
Blockly.beatleLineSensorValues="Line sensor";
Blockly.beatleValueread="'s value";
Blockly.linesensors="Line sensors:";
Blockly.MaxValue="MaxValue";
Blockly.MinValue="MinValue"
Blockly.linesensorCalibration="Set Max and Min calibration value for line sensors";
Blockly.beatleLinePostion="Get line position";
Blockly.LineSensorCalibration="Start line sensor calibration";
Blockly.Yes="Yes";
Blockly.No="No";
