...
Blockly.Msg.BASKETSPEEDONEONE= "When the score is less than";
Blockly.Msg.BASKETSPEEDONETWO= "points, the speed of the basket is:0";
Blockly.Msg.BASKETSPEEDTWOTWO= "points, the speed of the basket is: low speed";
Blockly.Msg.BASKETSPEEDTHREETWO= "points, the speed of the basket is: high speed";

Blockly.Msg.SCOREONE = "When the shooting robot";
Blockly.Msg.SCORETWO = "shot the goal， it will get";
Blockly.Msg.SCORETHREE = "points";

Blockly.Msg.PURSUIT = "Catch up with obstacles";
Blockly.Msg.PRESSSHAKE = "Press the nose to shake the tail 3 times";


Blockly.Msg.OBSTACLEGOBACKONE = "When dinosaurs";
Blockly.Msg.OBSTACLEGOBACKTWO = " encounter obstacles";
Blockly.Msg.OBSTACLEGOBACKTHREE = ",avoid obstacles";


Blockly.Msg.SCANNINGGOFORWARD = "The dinosaur scans and walks forward";

Blockly.Msg.LIFEPARTONE = "Life value：The robot was hit ";
Blockly.Msg.LIFEPARTTWO = "times,and will lose the connection";
Blockly.Msg.PRESSFIGHT = "Start hitting after the enemy";
Blockly.Msg.PRESSBACK = "Press the middle button and the robot back";
Blockly.Msg.LEFTGO = "Press the button on the left and move the left wheel of the robot";
Blockly.Msg.RIGHTGO = "Press the button on the right and move the right wheel of the robot";
Blockly.Msg.CATCALLING = "  a cat calling";
Blockly.Msg.CATWVAING = "  a cat waving";
...
//Zeroworkshop
Blockly.ZEROWORKSHOP_MOVEMETN_LEFT = 'Go Left';
Blockly.ZEROWORKSHOP_MOVEMETN_RIGHT = 'Go Right';
Blockly.ZEROWORKSHOP_MOVEMETN_FORWARD = 'Go Forward';
Blockly.ZEROWORKSHOP_MOVEMETN_REVERSE = 'Go Reverse';
Blockly.ZEROWORKSHOP_MOVEMETN_STOP = 'Go STOP';

Blockly.ZEROWORKSHOP_PLAYNUM = 'Play Num.';
Blockly.ZEROWORKSHOP_PLAYSONG = 'Song';
Blockly.ZEROWORKSHOP_PS2_MSG = 'Controller';
Blockly.ZEROWORKSHOP_PS2_PAD_IF = 'If press';
Blockly.ZEROWORKSHOP_PS2_PAD_ELSEIF = 'Else Press';
Blockly.ZEROWORKSHOP_PS2_PAD_ELSE = 'Else';
Blockly.ZEROWORKSHOP_PS2_BUTTON = 'Botton';

Blockly.ZEROWORKSHOP_IR_SENSOR = 'If IR sensor';
Blockly.ZEROWORKSHOP_IF_SENSOR_IFELSE = 'Otherwise if IR sensor';
Blockly.ZEROWORKSHOP_IR_SENSOR_OBSTACLE = 'sees an obstacle';
//luokailiang
...
Blockly.MIXLY_PULSEIN='pulseIn(��s) PIN#';
Blockly.MIXLY_PULSEIN_STAT='state';
Blockly.MIXLY_PULSEIN_TIMEOUT='timeout(��s)';
...
var MSG = {
  remoteControl_T2:' remoteControl',
  catInOut: "action",
  catControl: "Control",
  catMath: "Math",
  fightR: "Fight Robot",
...
//catEthernet:"Light",
  ...
  viewLevelA:"A",
  viewLevelM:"M",
  catMovement:"Lesson FOUR",
  behavior:'behavior',
  catSound:"Lesson THREE",
  catInputController:"Lesson TWO",
  catLight:"Light",
  catPantilt:"CameraMovement",
  car:'Lesson ONE',
  bird:'Lesson FIVE',
