...
Blockly.Msg.BASKETSPEEDONEONE= "当得分小于";
Blockly.Msg.BASKETSPEEDONETWO= "时 ，篮筐转速为: 0 。";
Blockly.Msg.BASKETSPEEDTWOTWO= "时 ，篮筐转速为:低速。";
Blockly.Msg.BASKETSPEEDTHREETWO= "时 ，篮筐转速为:高速。";



Blockly.Msg.SCOREONE = "投篮机器人";
Blockly.Msg.SCORETWO = "进球时得";
Blockly.Msg.SCORETHREE = "分";





Blockly.Msg.PURSUIT = "遇到障碍物的时候追赶";
Blockly.Msg.PRESSSHAKE = "按下鼻子摇尾巴3次";



Blockly.Msg.OBSTACLEGOBACKONE = "当恐龙";
Blockly.Msg.OBSTACLEGOBACKTWO = "遇到障碍物";
Blockly.Msg.OBSTACLEGOBACKTHREE = "的时候避开障碍物";
Blockly.Msg.SCANNINGGOFORWARD = "恐龙左右扫描并向前行走";

Blockly.Msg.LIFEPARTONE = "生命值：机器人被击中";
Blockly.Msg.LIFEPARTTWO = "次后失去连接";
Blockly.Msg.PRESSFIGHT = "发动攻击,击中后对手掉失去一滴生命值";
Blockly.Msg.PRESSBACK = "按下中间按钮机器人后退";

Blockly.Msg.LEFTGO = "按下左边的按钮机器人左轮前进";
Blockly.Msg.RIGHTGO = "按下右边的按钮机器人右轮前进";

Blockly.Msg.CATCALLING = " 小猫喵叫";
Blockly.Msg.CATWVAING = " 小猫招手";
...
//Zeroworkshop
Blockly.ZEROWORKSHOP_MOVEMETN_LEFT = '左转';
Blockly.ZEROWORKSHOP_MOVEMETN_RIGHT = '右转';
Blockly.ZEROWORKSHOP_MOVEMETN_FORWARD = '前进';
Blockly.ZEROWORKSHOP_MOVEMETN_REVERSE = '后退';
Blockly.ZEROWORKSHOP_MOVEMETN_STOP = '停止';

Blockly.ZEROWORKSHOP_PLAYNUM = '播放第';
Blockly.ZEROWORKSHOP_PLAYSONG = '歌曲';
Blockly.ZEROWORKSHOP_PS2_MSG = '遥控器';
Blockly.ZEROWORKSHOP_PS2_PAD_IF = '如果按下';
Blockly.ZEROWORKSHOP_PS2_PAD_ELSEIF = '否则按下';
Blockly.ZEROWORKSHOP_PS2_PAD_ELSE = '否则';
Blockly.ZEROWORKSHOP_PS2_BUTTON = '键';

Blockly.ZEROWORKSHOP_IR_SENSOR_MSG = '红外线接收传感器';
Blockly.ZEROWORKSHOP_IR_SENSOR = '如果传感器';
Blockly.ZEROWORKSHOP_IF_SENSOR_IFELSE = '否则如果传感器';
Blockly.ZEROWORKSHOP_IR_SENSOR_OBSTACLE = '遇到障碍';

Blockly.ZEROWORKSHOP_BUTTON_MSG = '开关按键输入';
Blockly.ZEROWORKSHOP_BUTTON_SENSOR = '如果开关按键';
Blockly.ZEROWORKSHOP_BUTTON_PRESSED = '按下';
Blockly.ZEROWORKSHOP_BUTTON_SENSOR_IFELSE = '否则如果开关按键';
...
//catFactory:'灯光',
  ...
  movement:'运动模块',
  act:'动作模块',
  remoteControl_T2:'控制模块',
  motor_modular:'马达动作',
  servo_modular:'伺服动作',
  sensor_modular:'传感器模块',
  logical_modular:'逻辑模块',
  timing_modular:'定时模块',
  lighteffects_modular:'灯光模块',
  sound_modular:'声音模块',
  findLine_modular:'巡线模块',
  t3_move_modular:'运动模块',
  switch_modular:'开关模块',
  lighteffects_modular_T3:'灯光模块',
  logical_modular_t4:'控制模块',
  volume_modular_t4:'语音模块',
  motor_modular_t4:'电机模块',
  servo_modular_t4:'伺服模块',
  lamp_modular_t4:'灯光模块',
  sensor_modular_t4:'传感模块',
  logic_modular_t4:'逻辑模块',
  sensor_modular_t5:'传感模块',
  variable_modular_t5:'变量模块',
  delay_modular_t5:'延时模块',
  logic_modular_t5:'逻辑模块',
  serial_modular_t5:'串口输出',
  servo_modular_t5:'伺服模块',
  math_modular_t5:'数学模块',
  lamp_modular_t5:'灯光模块',
  text_modular_t5:'文本模块',
  dinosaur:'恐龙先锋',
  flyBird:'飞鸟伯德',
  preEMovement:'运动模块',
  preEAction:'动作模块',
...
Blockly.MIXLY_TOOLTIP_CONTROL_SETUP='初始化操作(这里面的内容只执行一次) qixin来过这里';
