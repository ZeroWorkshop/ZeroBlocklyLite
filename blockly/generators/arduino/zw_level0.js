...
stc+='            rgb.blue_max = 0;\n'
stc+='         if (tcs.begin()) {\n'
stc+='           Serial.println("Sensor founded!");\n'
stc+='         } else {\n'
stc+='           Serial.println("TCS34725 is not available, please try check it !");\n'
stc+='           while (1); \n'
stc+='         } \n'
stc+='     \n'
...
stc+='     {\n'
stc+='          Serial.println("=======================================================================");\n'
stc+='          Serial.println("Please follow bellow steps to calibration those colors.");  \n'
stc+='          Serial.println("Step 1: Read the color of surronding.");\n'
stc+='          Serial.println("\t  Please keep nothing and try to adjust the position of the sensor, then press button A1.");\n'
stc+='          Serial.print  ("\t  Please do the same steps and try "); Serial.print(COLOR_CALIBRATION_TIMES); Serial.println(" times at least.");\n'
stc+='          Serial.println("\t  Please press button A2 when finished. it will save the surrounding color data to EEPROM.");   \n'
stc+='     }\n'
stc+='     else\n'
stc+='     {\n'
...
stc+='           Serial.print("Read Color "); Serial.print(i);Serial.print(" data from EEPROM ");Serial.print(COLOR_START_POS); Serial.print(":\t");    \n'
stc+='           Serial.print(" red:"); Serial.print(RGB_STORE_DATA[i].red, DEC); Serial.print(":");Serial.print(RGB_STORE_DATA[i].red_max, DEC); Serial.print(":");Serial.print(RGB_STORE_DATA[i].red_min, DEC);\n'
stc+='           Serial.print(" green:");Serial.print(RGB_STORE_DATA[i].green, DEC);Serial.print(":"); Serial.print(RGB_STORE_DATA[i].green_max, DEC); Serial.print(":");Serial.print(RGB_STORE_DATA[i].green_min, DEC);\n'
stc+='           Serial.print(" blue:"); Serial.print(RGB_STORE_DATA[i].blue, DEC);Serial.print(":");Serial.print(RGB_STORE_DATA[i].blue_max, DEC); Serial.print(":");Serial.print(RGB_STORE_DATA[i].blue_min, DEC);\n'
stc+='           Serial.println("");\n'
stc+='     }\n'
stc+='     }\n'
stc+='     \n'
...
str+='     {\n'
str+='         Serial.print(rgb.red, DEC); Serial.print("\t");Serial.print(rgb.green, DEC); Serial.print("\t");Serial.print(rgb.blue, DEC);\n'
str+='         Serial.print(" R:"); Serial.print(rgb.red_max, DEC); Serial.print(":");Serial.print(rgb.red_min, DEC);\n'
str+='         Serial.print(" G:");Serial.print(rgb.green_max, DEC); Serial.print(":");Serial.print(rgb.green_min, DEC);\n'
str+='         Serial.print(" B:"); Serial.print(rgb.blue_max, DEC); Serial.print(":");Serial.print(rgb.blue_min, DEC);\n'
str+='     }\n'
str+='     else\n'
str+='     {\n'
...
str+='             Serial.print("Write Color "); Serial.print(ColorNum);Serial.print(" data to EEPROM ");Serial.print(COLOR_START_POS); Serial.println(":\t");    \n'
str+='             Serial.print(" red:"); Serial.print(rgb.red, DEC); Serial.print(":");Serial.print(rgb.red_max, DEC); Serial.print(":");Serial.print(rgb.red_min, DEC);\n'
str+='             Serial.print(" green:");Serial.print(rgb.green, DEC);Serial.print(":"); Serial.print(rgb.green_max, DEC); Serial.print(":");Serial.print(rgb.green_min, DEC);\n'
str+='             Serial.print(" blue:"); Serial.print(rgb.blue, DEC);Serial.print(":");Serial.print(rgb.blue_max, DEC); Serial.print(":");Serial.print(rgb.blue_min, DEC);\n'
str+='             Serial.println("");\n'
str+='           num = 0;\n'
str+='           rgb.red = 0;\n'
str+='           rgb.red_min = 255;\n'
...
str+='           {\n'
str+='               Serial.print("Step "); Serial.print(ColorNum+1); Serial.print(": Read the color of No.");Serial.print(ColorNum); Serial.println(" object");\n'
str+='               Serial.print("\t  Please put No.");Serial.print(ColorNum); Serial.println(" object and try to adjust the position of the sensor, then press button A1.");\n'
str+='               Serial.print("\t  Please do the same steps and try "); Serial.print(COLOR_CALIBRATION_TIMES); Serial.println(" times at least.");\n'
str+='               Serial.print("\t  Please press button A2 when finished. it will save the color data of No.");Serial.print(ColorNum);Serial.println(" object to EEPROM.");\n'
str+='           } \n'
str+='           if( ColorNum >= COLOR_NUM_MAX) {\n'
str+='             CALIBRATION_COLOR = false;\n'
str+='             Serial.println("Calibrantion finished.!!!");\n'
str+='             };\n'
str+='           }\n'
str+='         }\n'
str+='     \n'
...
str+='         Serial.print(" The bollChose of this object is "); Serial.println(bollChoosed); Serial.print(" The color of this object is "); Serial.println(color);\n'
str+='         delay(1000);\n'
str+='         \n'
