...
Blockly.Arduino.serial_print = function() {
  ...
  if(Blockly.Arduino.setups_['setup_serial_'+serial_select+profile.default.serial]){
	...
	Blockly.Arduino.setups_['setup_serial_'+serial_select+profile.default.serial] = serial_select+'.begin(115200);';
  }
  var code = serial_select+'.print('+content+');\n';
  return code;
};

Blockly.Arduino.serial_print_t5 = function() {
  var serial_select = 'Serial';
  var content = Blockly.Arduino.valueToCode(this, 'CONTENT', Blockly.Arduino.ORDER_ATOMIC) || '\"\"'
  if(Blockly.Arduino.setups_['setup_serial_'+serial_select+profile.default.serial]){
  }else{
	Blockly.Arduino.setups_['setup_serial_'+serial_select+profile.default.serial] = serial_select+'.begin(115200);';
...
Blockly.Arduino.serial_println_t5 = function() {
  var serial_select = 'Serial';
  var content = Blockly.Arduino.valueToCode(this, 'CONTENT', Blockly.Arduino.ORDER_ATOMIC) || '\"\"'
  if(Blockly.Arduino.setups_['setup_serial_'+serial_select+profile.default.serial]){
  }else{
